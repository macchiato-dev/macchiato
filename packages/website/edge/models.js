...
export function publicResponseHeaders(key, upstreamHeaders = new Headers()) {
  ...
  headers.set("content-security-policy", key.startsWith("-/blog-examples/")
    ...
    : `default-src 'self'; script-src 'self' 'wasm-unsafe-eval'; style-src 'self' 'unsafe-inline'; font-src 'self' data:; connect-src 'self' https://cdn.jsdelivr.net https://unpkg.com https://blog-examples.resources.co https://staging-blog-examples.resources.co http://blog-examples.localhost:*; img-src 'self' data:; frame-src 'self' https://codesandbox.io https://blog-examples.resources.co https://staging-blog-examples.resources.co http://blog-examples.localhost:*; object-src 'none'; base-uri 'none'; frame-ancestors ${embeddedRunner ? "'self'" : "'none'"}; form-action 'self'`);
