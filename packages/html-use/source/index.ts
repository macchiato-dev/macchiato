...
export class HtmlFragment {
  tagName = "#fragment";
  children: HtmlNodeLike[] = [];
  parentNode: HtmlNodeLike | null = null;

  appendChild(child: HtmlNodeLike) {
    this.children.push(child);
    child.parentNode = this;
    return child;
  }

  removeChild(child: HtmlNodeLike) {
 ...
 */
export function parseHTML(html: string, { createElement, createTextNode, schema, styleUse, strict = false }: ParseHtmlOptions) {
