...
export function controlState(root) {
  return Array.from(root.querySelectorAll("input[data-node-id], textarea[data-node-id], select[data-node-id]"), (node: any) => ({
...
export function sourceValue(root, target, options: any = {}) {
