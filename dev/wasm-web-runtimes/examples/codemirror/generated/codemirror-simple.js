(() => {
  ...
  var MouseSelection = class {
    ...
    select(event) {
      let { view: view2 } = this, selection2 = skipAtomsForSelection(this.atoms, this.style.get(event, this.extend, this.multiple));
  ...
  function attrsFromFacet(view2, facet, base2) {
    for (let sources = view2.state.facet(facet), i2 = sources.length - 1; i2 >= 0; i2--) {
