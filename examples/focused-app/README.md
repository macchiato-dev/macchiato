...
workspace whose sidebar can collapse completely.
...
Open `http://app.localhost:8765`. Use the sidebar toggle for a full-screen app,
`Ctrl/Cmd-K` for the command surface, or drag a text file anywhere onto the
page. Files larger than 1 MB default to Memory. Manual changes in Memory or
Session Storage enable the browser's leave-page warning.
